 ...
 * image loaded, tile width and height, and the transparent color associated
 * with it
 */
public class TileSheet {
     ...
     *
     * @param spriteSheet - The raw image file which contains all of the Tile
     * images
     ...
     * file and custom height and width sizes for each Tile
     *
     * @param spriteSheetFile - The image file which contains all of the Tile
     * images
     * @param tileW - The width of each Tile
     * @param tileH - The height of each Tile
     */
    ...
    /**
     * Determines whether the image is considered an object tile or not based on
     * whether or not it contains a pixel which is the same color as the
     * transparentColor field
     *
    ...
    /**
     * Converts all of the specified transparent color pixels into actually
     * transparent pixels
     *
    ...
    /**
     * Called at the end of each constructor, this method breaks up the raw
     * sprite sheet image into individual Tiles and adds them to the TileSheet's
